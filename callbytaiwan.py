    ...
    if int(phone) <= 99999999 or int(phone) >= 999999999:
         ...
         for i in range(1):
             ...
             if 'error' in snd.text or sed.text:
                  time.sleep(1)
                  print('\x1b[92m[ By.ชัช ]\x1b[00m : \x1b[96m確認番号の送信に成功しました ✓ \x1b[00m')
                  time.sleep(2)

             else:
                  time.sleep(1)
                  print('\x1b[92m[ By.ชัช ]\x1b[00m : \x1b[91m確認番号を送信できませんでした !\x1b[00m')
         time.sleep(1)
         print ('')
         hme = input('\x1b[92m[ By.ชัช] : 最初からやり直したいですか Y/N ?\x1b[00m \x1b[91m »\x1b[00m  \x1b[92m')
         print ('')
         if str(hme) == 'y' or str(hme) == 'Y':
              print('\x1b[92m[ By.ชัช]\x1b[00m : \x1b[96m家に入るのを終えた ~ \x1b[00m')
              time.sleep(2)
              os.system('clear')
              home()
         elif str(hme) == 'n' or str(hme) == 'N':
              print('\x1b[92m[ By.ชัช ]\x1b[00m : \x1b[96m正常にキャンセルされました √ \x1b[00m')
         else: print('\x1b[92m[ E ]\x1b[00m : \x1b[91m不合格 X \x1b[00m')
